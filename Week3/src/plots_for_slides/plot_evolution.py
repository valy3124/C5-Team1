...
# Image to plot
img_name = "VizWiz_train_00022797.jpg"
...
epochs_to_show = [1, 2, 3, 5, 8, 10, 12]
...
ax_left.imshow(img)
ax_left.set_title("Target Image: Tomato Soup", fontsize=20, fontweight='bold', color=color_primary, pad=20)
...
for ep in epochs_to_show:
    ...
    pred_color = '#e63946' if ep < 3 else ('#f4a261' if ep < 10 else '#2d9e6b')
    if ep == 12: pred_color = '#1f4e79'
...
plt.tight_layout()
plt.savefig("/ghome/group01/C5/vali/C5-Team1/Week3/caption_evolution.png", dpi=300, bbox_inches='tight')
print("Successfully generated caption_evolution.png")
